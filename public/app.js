...
// Agregar tarjeta de repuesto
function createPartCard(part) {
    return `
        <div class="part-card">
            <div class="part-name">${part.name}</div>
            <div class="part-price">$${formatPrice(part.price)}</div>
            <div class="part-stock">Stock: ${part.stock} unidades</div>
...
window.addEventListener('load', async () => {
    ...
    setTimeout(() => {
        const welcomeMsg = `¡Hola! 👋 Soy tu asistente de repuestos para motos colombianas.
...
¿Qué necesitas?`;
        ...
        // Remover mensaje de bienvenida estático
